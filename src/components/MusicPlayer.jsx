...
import musicFile from '../assets/musics/AmartePorMilAnhosMas.mp3'
    ...
    return (
        <section className='px-2 py-4 w-3/4 bg-primary bg-cover bg-center shadow-lg rounded-lg flex items-center gap-4' style={{ backgroundImage: `url(${bg})` }}>
            ...
            <section className='flex flex-col w-full gap-2'>
                <section>
                    <p className='font-bold font-sukar text-white'>Amarte por Mil Años Mas</p>
                    <p className='font-sukar text-white'>Christina Perri</p>
                </section>
